...
const CONTENT = {
  ...
  hierarquia: [
    ...
    {
      cargo: "SOLDADO",
      funcao: "Linha de frente: território, escolta, negócio e presença de rua.",
      nome: "NOME DO PERSONAGEM",
      id: "ID 000",
      foto: null,
    },
    {
      cargo: "NOVATO",
      funcao: "Em período de prova, com padrinho. Não veste as cores nem toca no negócio até provar lealdade e RP de qualidade.",
      nome: "NOME DO PERSONAGEM",
      id: "ID 000",
      foto: null,
    },

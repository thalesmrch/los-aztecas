...
const CONTENT = {
  ...
  tropaIntro:
    "A tropa é a linha de frente do barrio: território, escolta, negócio e presença de rua. Novato entra em período de prova, com padrinho, e só veste as cores depois de provar lealdade e RP. Os IDs ainda estão em organização.",

  // efetivo — todos soldados por enquanto. id: "" quando ainda não definido.
  soldados: [
    { nome: "Tony Pierre", id: "" },
    { nome: "Kzn", id: "" },
    { nome: "Apolo Aldrin", id: "" },
    { nome: "Barbara Sativa", id: "" },
    { nome: "Jhon Onda", id: "" },
    { nome: "John Love", id: "" },
    { nome: "WL", id: "" },
    { nome: "Milkshake", id: "" },
